...
const UpdateProduct = () => {
  ...
  const getSingleProduct = async () => {
    try {
      ...
      setdes1(data.product.des1);
      setdes2(data.product.des2);
      setdes3(data.product.des3);
      setdes4(data.product.des4);
      setdes5(data.product.des5);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      productData.append("des1", des1);
      productData.append("des2", des2);
      productData.append("des3", des3);
      productData.append("des4", des4);
      productData.append("des5", des5);
