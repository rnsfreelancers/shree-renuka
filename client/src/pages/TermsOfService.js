    ...
    <Layout>
      <div className="container">
        ...
        <p className="paragraph">
          This website is operated by Vashi Integrated Solutions Limited.
          Throughout the site, the terms “we”, “us” and “our” refer to Vashi
          Integrated Solutions. Vashi Integrated Solutions offers this website,
        ...
        <h1 className="overview">SECTION 1 - ONLINE STORE TERMS</h1>
        <p className="online-items">
        ...
        <h1 className="overview"> SECTION 2 - GENERAL CONDITIONS</h1>
        <p className="online-items">
        ...
        <h1 className="overview">SECTION 7 - OPTIONAL TOOLS</h1>
        <p className="online-items">
        ...
        <h1 className="overview">SECTION 8 - THIRD-PARTY LINKS</h1>
        <p className="online-items">
        ...
        <h1 className="overview">SECTION 10 - PERSONAL INFORMATION</h1>
        <p className="paragraph">
        ...
        <h1 className="overview">SECTION 12 - PROHIBITED USES</h1>
        <p className="paragraph">
        ...
        <p className="paragraph">
          In no case shall Vashi Integrated Solutions Limited, our directors,
        ...
        <h1 className="overview">SECTION 14 - INDEMNIFICATION</h1>
        <p className="paragraph">
          You agree to indemnify, defend and hold harmless Vashi Integrated
          Solutions Limited and our parent, subsidiaries, affiliates, partners,
        ...
        <h1 className="overview">SECTION 15 - SEVERABILITY</h1>
        <p className="paragraph">
        ...
        <h1 className="overview">SECTION 16 - TERMINATION</h1>
        <p className="online-items">
        ...
        <h1 className="overview">SECTION 17 - ENTIRE AGREEMENT</h1>
        <p className="online-items">
        ...
        <h1 className="overview">SECTION 18 - GOVERNING LAW</h1>
        <p className="paragraph">
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of India.
        </p>
        <h1 className="overview">SECTION 19 - CHANGES TO TERMS OF SERVICE</h1>
        <p className="online-items">
        ...
        <h1 className="overview">SECTION 20 - CONTACT INFORMATION</h1>
        <p className="paragraph">
          Questions about the Terms of Service should be sent to us at
          buyonline@vashiisl.com.
        </p>
      </div>
    </Layout>
  );
