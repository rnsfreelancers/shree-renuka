...
import "../assests/styles/PrivacyPolicy.css"
...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="privacy-policy-container">
        ...
        <h2 className='info'>Information Collection and Use</h2>
        <p>
        ...
        <h2 className='info'>Log Data</h2>
        <p>
          Like many site operators, we collect information that your browser sends whenever you visit our Site ("Log Data"). This Log Data may include information such as your computer's Internet Protocol ("IP") address, browser type, browser version, the pages of our Site that you visit, the time and date of your visit, the time spent on those pages, and other statistics. In addition, we may use third-party services such as Google Analytics that collect, monitor, and analyze this data for the purpose of improving our Site's functionality and performance.
        </p>
        <h2 className='info'>Cookies</h2>
        <p>
